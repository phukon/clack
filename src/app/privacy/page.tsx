    ...
    <>
      ...
      <div className="relative pt-36 md:pt-48 pb-14 mx-auto  px-4 lg:px-8 bg-white text-black">
        <article className="prose prose-slate mx-auto">
          ...
          <p>
            Clack (“us”, “we”, or “our”) operates <a href="https://clack.rkph.me">https://clack.rkph.me</a> (hereinafter referred
            to as “<strong>Service</strong>”).
          </p>
          <p>
            Our Privacy Policy governs your visit to <a href="https://clack.rkph.me">https://clack.rkph.me</a>, and explains how
          ...
          <p>
            Our Terms and Conditions (“<strong>Terms</strong>”) govern all use of our Service and together with the Privacy Policy
          ...
          <p>
            <strong>PERSONAL DATA</strong> means data about a living individual who can be identified from those data (or from
            those and other information either in our possession or likely to come into our possession).
          </p>
          <p>
            <strong>USAGE DATA</strong> is data collected automatically either generated by the use of Service or from Service
          ...
          <p>
            <strong>DATA CONTROLLER</strong> means a natural or legal person who (either alone or jointly or in common with other
            persons) determines the purposes for which and the manner in which any personal data are, or are to be, processed. For
            the purpose of this Privacy Policy, we are a Data Controller of your data.
          </p>
          <p>
            <strong>DATA PROCESSORS (OR SERVICE PROVIDERS)</strong> means any natural or legal person who processes the data on
            behalf of the Data Controller. We may use the services of various Service Providers in order to process your data more
            effectively.
          </p>
          <p>
          ...
          <p>
            <strong>THE USER</strong> is the individual using our Service. The User corresponds to the Data Subject, who is the
          ...
          <p>
            ...
            used to contact or identify you (“<strong>Personal Data</strong>”). Personally identifiable information may include,
          ...
          <p>
            ...
            by following the unsubscribe link.
          </p>
          <p>
          ...
          <p>
            Clack will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with
            this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there
          ...
          <p>
            For more information on what data GitHub collects for what purpose and how the protection of the data is ensured,
